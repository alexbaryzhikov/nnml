...
def learn_perceptron():
    ...
    # Read data
    # The variables have _nobias appended to their names because they do not have an additional
    # column of 1's appended to them. This is done automatically in the following code.
