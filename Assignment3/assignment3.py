...
# Idle run, see the baseline performance of untrained net.
...
# Test decay loss
# a3(wd_coefficient = 1e7, n_hid = 7, n_iters = 10, learning_rate = 0,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)

# Test decay loss
# a3(wd_coefficient = 0, n_hid = 7, n_iters = 10, learning_rate = 0,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)

## OPTIMIZATION PART

# Small version
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 5e-3,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)

# Learing rate and momentum trials
# print("\n--------------- LR = 0.002, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 2e-3,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.002, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 2e-3,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.01, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 1e-2,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.01, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 1e-2,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.05, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 5e-2,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.05, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 5e-2,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.2, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 2e-1,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 0.2, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 2e-1,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 1.0, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 1e0,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 1.0, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 1e0,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 5.0, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 5e0,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 5.0, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 5e0,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 20.0, MM = 0.0 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 2e1,
#     momentum_multiplier = 0, do_early_stopping = False, mini_batch_size = 4)
# print("\n--------------- LR = 20.0, MM = 0.9 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 70, learning_rate = 2e1,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 4)
...
# Work on validation loss
# a3(wd_coefficient = 0, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
...
# Weight decay trials
# print("\n--------------- WD = 0.0001 ---------------")
# a3(wd_coefficient = 1e-4, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- WD = 0.001 ---------------")
# a3(wd_coefficient = 1e-3, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- WD = 0.1 ---------------")
# a3(wd_coefficient = 0.1, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- WD = 0.0 ---------------")
# a3(wd_coefficient = 0.0, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- WD = 1.0 ---------------")
# a3(wd_coefficient = 1.0, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- WD = 10.0 ---------------")
# a3(wd_coefficient = 10.0, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)

# Hidden layer size trials
# print("\n--------------- N_HID = 10 ---------------")
# a3(wd_coefficient = 0, n_hid = 10, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- N_HID = 30 ---------------")
# a3(wd_coefficient = 0, n_hid = 30, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- N_HID = 100 ---------------")
# a3(wd_coefficient = 0, n_hid = 100, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- N_HID = 130 ---------------")
# a3(wd_coefficient = 0, n_hid = 130, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)
# print("\n--------------- N_HID = 200 ---------------")
# a3(wd_coefficient = 0, n_hid = 200, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = False, mini_batch_size = 100)

# Hidden layer size with early stopping trials
# print("\n--------------- N_HID = 18 ---------------")
# a3(wd_coefficient = 0, n_hid = 18, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = True, mini_batch_size = 100)
# print("\n--------------- N_HID = 37 ---------------")
# a3(wd_coefficient = 0, n_hid = 37, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = True, mini_batch_size = 100)
# print("\n--------------- N_HID = 113 ---------------")
# a3(wd_coefficient = 0, n_hid = 113, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = True, mini_batch_size = 100)
# print("\n--------------- N_HID = 189 ---------------")
# a3(wd_coefficient = 0, n_hid = 189, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = True, mini_batch_size = 100)
# print("\n--------------- N_HID = 236 ---------------")
# a3(wd_coefficient = 0, n_hid = 236, n_iters = 1000, learning_rate = 0.35,
#     momentum_multiplier = 0.9, do_early_stopping = True, mini_batch_size = 100)
