...
def a4_init():
    ...
    # Set up data for testing unimplemented functions
    global test_rbm_w
    global small_test_rbm_w
    test_rbm_w       = a4_rand([100, 256], 0) * 2 - 1
    small_test_rbm_w = a4_rand([ 10, 256], 0) * 2 - 1

    global data_1_case
    global data_10_cases
    global data_37_cases
    ...
    global test_hidden_state_1_case
    global test_hidden_state_10_cases
    global test_hidden_state_37_cases
